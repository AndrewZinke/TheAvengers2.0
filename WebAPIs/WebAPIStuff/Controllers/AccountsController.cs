...
using WebAPIStuff.Providers;
using WebAPIStuff.Results;

namespace WebAPIStuff.Controllers
{
    [Authorize]
    [RoutePrefix("api/Account")]
    [EnableCors(origins: "http://localhost:57881", headers: "*", methods: "*")]
    public class AccountController : ApiController
    {
        ...
        // http://localhost:54756/api/account/login
        // {"username":"ajay.singala@gmail.com","password":"Password@123"}
        [HttpPost]
        [AllowAnonymous]
        [Route("Login")]
